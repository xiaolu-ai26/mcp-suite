...
MANUFACTURING_CONTINUATION = 'tbllqb2R9itUKXdH'
TABLES = [*ORIGINAL_TABLES, INTERNET_CONTINUATION, MANUFACTURING_CONTINUATION]

def valid_table_selection(tables):
    return set(tables) in (set(ORIGINAL_TABLES), {*ORIGINAL_TABLES, INTERNET_CONTINUATION}, set(TABLES))
