...
# The 20260919f batch contributed 5 net new names; the 20260919g full-site batch
# appended 54 more careersite tenants, of which 52 are net new in the default set.
# 强生 keeps Workday, 斯堪尼亚 keeps Moka and 药明康德 keeps the hardcoded
# p1_sources_41_50 slot -- the tupu360 registration block is append-only setdefault,
# so a declared duplicate can never displace the earlier owner.
TUPU360_ONLY = (
    'IQVIA 艾昆纬', '礼来', '舍弗勒', '宝马', '茵梦达',
    "ABB", "Hella", "IBM校招", "Intel", "LVMH", "SK 海力士大连", "万集科技", "东莞徐记食品有限公司",
    "中力迅科技", "中国科学院光电技术研究所", "中国科学院计算技术研究所", "中科院软件所", "丰田汽车（中国）投资有限公司",
    "丹佛斯(上海)自动控制有限公司", "九牛电商", "华宝集团", "华晨宝马汽车有限公司", "华道数据处理有限公司", "厦门恒兴集团有限公司",
    "地中海度假集团", "埃森哲", "太古地产（中国）投资有限公司", "威纶通", "安德里茨（中国）有限公司", "广电计量检测集团股份有限公司",
    "康明斯", "康龙化成（北京）新药技术股份有限公司", "开利空调", "恒大集团有限公司", "日立电梯（中国）有限公司", "晖致医药有限公司",
    "森达美信昌机器工程有限公司", "森那美汽车", "清云智通（北京）科技有限公司", "百胜中国", "碧迪医疗器械(上海)有限公司",
    "福耀玻璃", "英华实验学校", "英特尔（校招）", "荞麦咨询", "莱茵技术（上海）有限公司", "西门子中国",
    "西门子医疗Siemens Healthineers", "西门子能源", "贺利氏", "赛诺菲（中国）投资有限公司上海分公司", "辉瑞",
    "辉瑞校招系统", "连通（杭州）技术服务有限公司", "道氏", "阿斯利康", "雅诗兰黛（上海）商贸有限公司",
)
# 20260918h shipped 924 companies; this cumulative branch adds 字节跳动/美的集团
# (20260918i), 22 foreign-batch-2 names (20260918j) and 57 tupu360-owned names
# (20260919f 5 + 20260919g 52; the 54 appended full-site lines lose 药明康德 to the
# hardcoded slot and 斯堪尼亚 to Moka).
EXPECTED_DEFAULT_COMPANIES = 1005
