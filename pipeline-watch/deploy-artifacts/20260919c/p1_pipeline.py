...
# micro-sites), and finally the 20260919c foreign batch-3 platform blocks
# (Avature, iCIMS, Oracle Recruiting Cloud). The merge of 20260918i, 20260918j and
# 20260919c keeps every append-only block verbatim, so no earlier company changes
# slot.
