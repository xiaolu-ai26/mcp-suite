...
GraduationYear = Annotated[str, TextIn, Field(
    description="用户的毕业届别，可填任意明确20xx届（2000至2099年）；2027、27届、2027年 会自动归一为 2027届。默认返回明确匹配、推断匹配和未注明三档；原文没写届别、按招聘季或来源专场推断为别的届的岗位归入含未注明（依据 推断为其他届别）。填 未注明 时只看没有任何届别线索的岗位。按届别筛选时社招岗位不返回",
